...
def get_common_args():
    ...
    parser.add_argument('--replay_alg',type=str,default="random",help='chose the replay algorithm')
    parser.add_argument('--alpha',type=float,default=0.7,help='mixture ratio')
